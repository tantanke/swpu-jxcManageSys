<template >
  <el-card class="box-card">
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" @close="onDialogClose()" width="80%" v-loading='editRole'>
  ...
  <el-tab-pane v-for="(role, key) in roleTree" :key="key" :label="role.permissionName">
    <el-tree
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="onEditRoleSubmit" v-if="dialogTitle=='角色授权'">保存</el-button>
...
<script>
import { getRoleList, getAllPermissiion ,getUserPermission} from '@/api/permission'
import { editData} from '@/api/data'
export default {
    data() {
        return {
            form: {

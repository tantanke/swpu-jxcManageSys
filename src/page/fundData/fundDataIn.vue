<template>
  <div class="fillcontain">
    <div class="contain">
      <div class="table_container">
        ...
        >
          ...
          <el-table-column property="name" label="入库人" align="center">
          </el-table-column>
          <el-table-column property="dateTime" label="入库时间" align="center" sortable>
          </el-table-column>
          <el-table-column
    ...
    <el-dialog title="添加入库信息" :visible.sync="userVisible" width="30%">
      <el-form
        :model="addForm"
        :rules="rules"
      ...
      >
        ...
        <el-form-item label="入库时间" prop="dateTime" label-width="120px">
         <el-date-picker
        ...
        <el-form-item label="入库人" prop="name" label-width="120px">
    ...
    <el-dialog title="编辑入库信息" :visible.sync="userEditVisible" width="30%">
      <el-form
        :model="editForm"
        :rules="rules2"
...
<script>
import { getInStoreList } from "@/api/user";

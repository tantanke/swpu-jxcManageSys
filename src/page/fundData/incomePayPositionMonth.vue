<template>
    <div class="fillcontain">
        <!-- <el-button type="warning" icon="el-icon-edit" @click="exportExcel" style="margin-bottom:10px">生成月度报表</el-button> -->
        ...
        methods: {
            ...
            initChart() {
                ...
                (function() {
                    ...
                    for (let i = 1; i < 13; i++) {
                       seriesIncome.push(Math.round(Math.random()*1000));
                       seriesPay.push(Math.round(Math.random()*1000));
                       seriesaverage.push(Math.round(Math.random()*1000));
                    }
